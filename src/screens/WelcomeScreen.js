...
export default function Welcome() {
  ...
  return (
    <View
      ...
      className="flex-1 justify-center items-center pb-6 bg-blue-900"
    >
      <LinearGradient
      ...
      <View className="flex-1 items-center justify-end max-w-[85%]  space-y-4 ">
        ...
        >
          Descubre las últimas noticias de la Universidad Autónoma de Querétaro
        </Text>
      </View>
      ...
      >
        <Text className="text-base text-blue-900">Empezar</Text>
      </TouchableOpacity>
    </View>
  );
}
