...
const breakingNewsUrl = `${apiBaseUrl}/top-headlines?country=mx&apiKey=${newsApiKey}`;
const recommendedNewsUrl = `${apiBaseUrl}/top-headlines?country=mx&category=business&apiKey=${newsApiKey}`;

const discoverNewsUrl = (discover) =>
  `${apiBaseUrl}/top-headlines?country=mx&category=${discover}&apiKey=${newsApiKey}`;
